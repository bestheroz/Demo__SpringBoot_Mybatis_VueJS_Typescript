ALTER TABLE SAMPLE_MEMBER_MST DROP PRIMARY KEY CASCADE;

DROP TABLE SAMPLE_MEMBER_MST CASCADE CONSTRAINTS;

CREATE TABLE SAMPLE_MEMBER_MST
             (
                          MEMBER_ID      VARCHAR2 (100 BYTE) PRIMARY KEY NOT NULL,
                          MEMBER_PW      CHAR (128 BYTE) NOT NULL,
                          MEMBER_NM      VARCHAR2 (100 BYTE) NOT NULL,
                          MEMBER_TYP     VARCHAR2 (100 BYTE) NOT NULL,
                          LOGIN_FAIL_CNT NUMBER (1) DEFAULT 0 NOT NULL,
                          IS_CLOSED       CHAR (1 BYTE) NOT NULL,
                          EXPIRE_DT      DATE NOT NULL,
                          REG_MEMBER_ID  VARCHAR2 (100 BYTE) NOT NULL,
                          REG_DT         DATE NOT NULL,
                          UPD_MEMBER_ID VARCHAR2 (100 BYTE) NOT NULL,
...
COMMIT;
ALTER TABLE SAMPLE_MENU_MST DROP PRIMARY KEY CASCADE;

DROP TABLE SAMPLE_MENU_MST CASCADE CONSTRAINTS;

CREATE TABLE SAMPLE_MENU_MST
             (
                          MENU_ID        NUMBER(10) PRIMARY KEY NOT NULL,
                          MENU_NM        VARCHAR2 (1000 BYTE) NOT NULL,
                          MENU_TYP       CHAR (1 BYTE) NOT NULL,
                          PAR_MENU_ID    NUMBER(10) NOT NULL,
                          USE_YN         CHAR (1 BYTE) NOT NULL,
                          POWER          NUMBER(10) NOT NULL,
                          DISP_SEQ       NUMBER(10) NOT NULL,
                          URL            VARCHAR2 (4000 BYTE),
                          REMARK1        VARCHAR2 (4000 BYTE),
                          REG_MEMBER_ID  VARCHAR2 (100 BYTE) NOT NULL,
                          REG_DT         DATE NOT NULL,
                          UPD_MEMBER_ID VARCHAR2 (100 BYTE) NOT NULL,
                          UPD_DT        DATE NOT NULL
...
DROP SEQUENCE SEQ_SAMPLE_MENU_MST;
...
COMMIT;
ALTER TABLE SAMPLE_CODE_MST DROP PRIMARY KEY CASCADE;

DROP TABLE SAMPLE_CODE_MST CASCADE CONSTRAINTS;

CREATE TABLE SAMPLE_CODE_MST
             (
                          GRCODE         VARCHAR2 (100 BYTE) PRIMARY KEY NOT NULL,
                          GRCODE_NM      VARCHAR2 (1000 BYTE) NOT NULL,
                          REMARK1        VARCHAR2 (4000 BYTE),
                          REG_MEMBER_ID  VARCHAR2 (100 BYTE) NOT NULL,
                          REG_DT         DATE NOT NULL,
                          UPD_MEMBER_ID VARCHAR2 (100 BYTE) NOT NULL,
...
COMMIT;
ALTER TABLE SAMPLE_CODE_DET DROP PRIMARY KEY CASCADE;

DROP TABLE SAMPLE_CODE_DET CASCADE CONSTRAINTS;

CREATE TABLE SAMPLE_CODE_DET
             (
                          GRCODE         VARCHAR2 (100 BYTE) NOT NULL,
                          CODE           VARCHAR2 (100 BYTE) NOT NULL,
                          CODE_NM        VARCHAR2 (1000 BYTE) NOT NULL,
...
CREATE UNIQUE INDEX PK_SAMPLE_CODE_DET
ON SAMPLE_CODE_DET
              (
                            GRCODE,
                            CODE
...
ALTER TABLE SAMPLE_CODE_DET ADD ( CONSTRAINT PK_SAMPLE_CODE_DET PRIMARY KEY (GRCODE, CODE) USING INDEX PK_SAMPLE_CODE_DET ENABLE VALIDATE);
...
COMMIT;
DROP TABLE SAMPLE_FILE_MST;

CREATE TABLE SAMPLE_FILE_MST
             (
                          FILE_SEQ       NUMBER(10) PRIMARY KEY NOT NULL,
                          FILE_NM        VARCHAR2(4000 BYTE) NOT NULL,
                          FILE_NM_EXT    VARCHAR2(100 BYTE) NOT NULL,
                          MIME_TYP       VARCHAR2(100 BYTE) NOT NULL,
