...
//                    sql.VALUES(TABLE_COLUMN_NAME_CREATED_BY, "'" + SessionUtils.getEmpId() + "'");
//                } else if (StringUtils.equals(javaFieldName, VARIABLE_NAME_UPDATED_BY)) {
//                    sql.VALUES(TABLE_COLUMN_NAME_UPDATED_BY, "'" + SessionUtils.getEmpId() + "'");
//                }
//            }
//        }
//
...
//                } else if (StringUtils.equals(javaFieldName, VARIABLE_NAME_UPDATED_BY)) {
//                    sql.SET(MessageFormat.format(SET_UPDATED_BY_BIND_STRING, TABLE_COLUMN_NAME_UPDATED_BY, SessionUtils.getEmpId()));
//                }
//            }
//        }
