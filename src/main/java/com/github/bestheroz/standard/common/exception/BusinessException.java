...
public class BusinessException extends RuntimeException {
  ...
  public static final BusinessException ERROR_SYSTEM = new BusinessException(
    ExceptionCode.ERROR_SYSTEM
  );
  public static final BusinessException FAIL_INVALID_REQUEST = new BusinessException(
    ExceptionCode.FAIL_INVALID_REQUEST
  );
  public static final BusinessException FAIL_INVALID_PARAMETER = new BusinessException(
    ExceptionCode.FAIL_INVALID_PARAMETER
  );
  public static final BusinessException FAIL_TRY_LOGIN_FIRST = new BusinessException(
    ExceptionCode.FAIL_TRY_LOGIN_FIRST
  );
  public static final BusinessException FAIL_NO_DATA_SUCCESS = new BusinessException(
  ...
  public boolean isEquals(final ExceptionCode exceptionCode) {
    return StringUtils.equals(
      (String) this.apiResult.get(ApiResult.CODE_KEY),
