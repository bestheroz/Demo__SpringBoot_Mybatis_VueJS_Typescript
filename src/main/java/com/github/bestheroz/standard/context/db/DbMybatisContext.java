...
public class DbMybatisContext {
  ...
  private SqlSessionFactoryBean getSqlSessionFactoryBean(
  ...
  @Autowired
  @Primary
  public SqlSessionTemplate getMySqlSessionTemplate(
    final ApplicationContext applicationContext,
    final HikariDataSource hikariDataSource
  )
    throws Exception {
    return new SqlSessionTemplate(
      Objects.requireNonNull(
        this.getSqlSessionFactoryBean(applicationContext, hikariDataSource)
          .getObject()
      )
    );
  }
